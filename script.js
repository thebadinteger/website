(function() {
    ...
    var translations = {
        en: {
            bioTitle: "hi.",
            bioDesc: 'i\'m <strong class="highlight">a reverse engineer</strong>, interested in IoT devices.<br>love all kinds of unusual gadgets.<br>from ukraine.<br><strong class="highlight">languages: Go, Nim, Python, Java, JS</strong>',
            support: "support",
            copyHint: "[copy]",
            copiedHint: "[copied!]"
        },
        ru: {
            bioTitle: "привет.",
            bioDesc: 'я <strong class="highlight">реверс-инженер</strong>, интересуюсь IoT девайсами.<br>люблю всякие необычные гаджеты.<br>из украины.<br><strong class="highlight">языки: Go, Nim, Python, Java, JS</strong>',
            support: "поддержать",
            copyHint: "[копировать]",
